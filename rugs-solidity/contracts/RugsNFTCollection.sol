...
contract RugsNFTCollection is ERC721URIStorage {
  ...
  constructor() ERC721 ("rugsNFTCollection", "RUGS") { // construct your token, needs name and symbol
    console.log("An NFT has been minted to %s", msg.sender);
  }

  function createRugsNFT() public { //function to create nfts
